...
contract WYZ is IERC20 {
    using SafeMath for uint256;

    uint8 public constant decimals = 18;    
    string public constant symbol = "WYZ";
    string public constant name = "Wyzth Network Token";
    ...
    function _validateSignedData(
        ...
        require(
            ...
            "WYZ::_validateSignedData: INVALID_SIGNATURE"
        );
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "WYZ::_transfer: NOT_VALID_TRANSFER"
        );
        // Balance is implicitly checked with SafeMath's underflow protection
        balanceOf[from] = balanceOf[from].sub(value);
        balanceOf[to] = balanceOf[to].add(value);
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "WYZ::permit: AUTH_EXPIRED");
    ...
    function transferWithAuthorization(
        ...
        require(block.timestamp > validAfter, "WYZ::transferWithAuthorization: AUTH_NOT_YET_VALID");
        require(block.timestamp < validBefore, "WYZ::transferWithAuthorization: AUTH_EXPIRED");
        require(!authorizationState[from][nonce], "WYZ::transferWithAuthorization: AUTH_ALREADY_USED");
