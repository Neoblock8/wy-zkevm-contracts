...
contract WyzthHelpers is Initializable {
    ...
    // bytes32 public constant WYZTH_NETWORK_HASH = keccak256(bytes("Wyzth Network")),
    bytes32 public constant WYZTH_NETWORK_HASH =
        0xbe287413178bfeddef8d9753ad4be825ae998706a6dabff23978b59dccaea0ad;
    ...
    function _checkSig(
        ...
        require(
            ...
            "WyzthHelpers::_checkSig: INVALID_S_VALUE"
        );
        ...
        require(
            ...
            "WyzthHelpers::_checkSig: INVALID_SIGNATURE"
        );
...
contract InstantWithdrawManager is WyzthHelpers {
    ...
    // Governance address
    address public wyzthGovernanceAddress;
    ...
    function _initializeWithdraw(
        address _wyzthGovernanceAddress,
        uint64 _withdrawalDelay,
        address _withdrawDelayerContract
    ) internal initializer {
        wyzthGovernanceAddress = _wyzthGovernanceAddress;
    ...
    modifier onlyGovernance {
        require(
            msg.sender == wyzthGovernanceAddress,
...
interface IWyzthAuctionProtocol {
    /**
...
interface IWithdrawalDelayer {
    /**
     * @notice Getter of the current `_wyzthGovernanceAddress`
     * @return The `_wyzthGovernanceAddress` value
     */
    function getWyzthGovernanceAddress() external view returns (address);
    ...
    /**
     * @notice This function allows the WyzthKeeperAddress to change the withdrawal delay time, this is the time that
    ...
    /**
     * Function to make a deposit in the WithdrawalDelayer smartcontract, only the Wyzth rollup smartcontract can do it
    ...
    /**
     * Allows the Wyzth Governance to withdawal the funds in the event that emergency mode was enable.
...
contract Wyzth is InstantWithdrawManager {
    ...
    // Contract interface of the wyzth auction
    IWyzthAuctionProtocol public wyzthAuctionContract;
     ...
     */
    function initializeWyzth(
        address[] memory _verifiers,
        uint256[] memory _verifiersParams,
        address _withdrawVerifier,
        address _wyzthAuctionContract,
        address _tokenHEZ,
        ...
        _initializeWithdraw(
            _wyzthGovernanceAddress,
            _withdrawalDelay,
            _withdrawDelayerContract
        );
        emit InitializeWyzthEvent(
    ...
    function forgeBatch(
        ...
        require(
            ...
            "Wyzth::forgeBatch: INTENAL_TX_NOT_ALLOWED"
        );

        // ask the auction if this coordinator is allow to forge
        require(
            wyzthAuctionContract.canForge(msg.sender, block.number) == true,
            "Wyzth::forgeBatch: AUCTION_DENIED"
        );

        if (!l1Batch) {
            require(
                block.number < (lastL1L2Batch + forgeL1L2BatchTimeout), // No overflow since forgeL1L2BatchTimeout is an uint8
                "Wyzth::forgeBatch: L1L2BATCH_REQUIRED"
            );
        }
        ...
        require(
            ...
            "Wyzth::forgeBatch: INVALID_PROOF"
        );
        ...
        wyzthAuctionContract.forge(msg.sender);
    ...
    function addL1Transaction(
        ...
        require(
            ...
            "Wyzth::addL1Transaction: TOKEN_NOT_REGISTERED"
        );
        ...
        require(
            ...
            "Wyzth::addL1Transaction: LOADAMOUNT_EXCEED_LIMIT"
        );
        ...
        if (loadAmount > 0) {
            if (tokenID == 0) {
                require(
                    ...
                    "Wyzth::addL1Transaction: LOADAMOUNT_ETH_DOES_NOT_MATCH"
                );
            } else {
                require(
                    msg.value == 0,
                    "Wyzth::addL1Transaction: MSG_VALUE_NOT_EQUAL_0"
                );
                if (permit.length != 0) {
                ...
                require(
                    ...
                    "Wyzth::addL1Transaction: LOADAMOUNT_ERC20_DOES_NOT_MATCH"
                );
            }
        }
    ...
    function _addL1Transaction(
        ...
        require(
            ...
            "Wyzth::_addL1Transaction: AMOUNT_EXCEED_LIMIT"
        );
        ...
        if (toIdx == 0) {
            require(
                (amount == 0),
                "Wyzth::_addL1Transaction: AMOUNT_MUST_BE_0_IF_NOT_TRANSFER"
            );
        } else {
            if ((toIdx == _EXIT_IDX)) {
                require(
                    (loadAmountF == 0),
                    "Wyzth::_addL1Transaction: LOADAMOUNT_MUST_BE_0_IF_EXIT"
                );
            } else {
                require(
                    ((toIdx > _RESERVED_IDX) && (toIdx <= lastIdx)),
                    "Wyzth::_addL1Transaction: INVALID_TOIDX"
                );
            }
        }
        ...
        if (fromIdx == 0) {
            require(
                babyPubKey != 0,
                "Wyzth::_addL1Transaction: INVALID_CREATE_ACCOUNT_WITH_NO_BABYJUB"
            );
        } else {
            require(
                (fromIdx > _RESERVED_IDX) && (fromIdx <= lastIdx),
                "Wyzth::_addL1Transaction: INVALID_FROMIDX"
            );
            require(
                babyPubKey == 0,
                "Wyzth::_addL1Transaction: BABYJUB_MUST_BE_0_IF_NOT_CREATE_ACCOUNT"
            );
        }
    ...
    function withdrawMerkleProof(
        ...
        if (instantWithdraw) {
            require(
                ...
                "Wyzth::withdrawMerkleProof: INSTANT_WITHDRAW_WASTED_FOR_THIS_USD_RANGE"
            );
        }
        ...
        require(
            ...
            "Wyzth::withdrawMerkleProof: WITHDRAW_ALREADY_DONE"
        );
        // check sparse merkle tree proof
        require(
            _smtVerifier(exitRoot, siblings, idx, stateHash) == true,
            "Wyzth::withdrawMerkleProof: SMT_PROOF_INVALID"
        );
    ...
    function withdrawCircuit(
        ...
        if (instantWithdraw) {
            require(
                _processInstantWithdrawal(tokenList[tokenID], amount),
                "Wyzth::withdrawCircuit: INSTANT_WITHDRAW_WASTED_FOR_THIS_USD_RANGE"
            );
        }
        require(
            exitNullifierMap[numExitRoot][idx] == false,
            "Wyzth::withdrawCircuit: WITHDRAW_ALREADY_DONE"
        );
        ...
        require(
            withdrawVerifier.verifyProof(proofA, proofB, proofC, [input]) ==
                true,
            "Wyzth::withdrawCircuit: INVALID_ZK_PROOF"
        );
        ...
        onlyGovernance
    {
        require(
            ...
            "Wyzth::updateForgeL1L2BatchTimeout: MAX_FORGETIMEOUT_EXCEED"
        );
    ...
    function addToken(address tokenAddress, bytes calldata permit) public {
        require(
            ...
            "Wyzth::addToken: TOTAL_SUPPLY_ZERO"
        );
        uint256 currentTokens = tokenList.length;
        require(
            currentTokens < _LIMIT_TOKENS,
            "Wyzth::addToken: TOKEN_LIST_FULL"
        );
        require(
            tokenAddress != address(0),
            "Wyzth::addToken: ADDRESS_0_INVALID"
        );
        require(tokenMap[tokenAddress] == 0, "Wyzth::addToken: ALREADY_ADDED");

        if (msg.sender != wyzthGovernanceAddress) {
    ...
    function _buildL1Data(uint256 ptr, bool l1Batch) internal view {
        ...
        require(
            ...
            "Wyzth::_buildL1Data: L1_TX_OVERFLOW"
        );
        ...
        for (uint256 i = 0; i < l1CoordinatorLength; i++) {
            ...
            require(
                tokenID < tokenList.length,
                "Wyzth::_buildL1Data: TOKEN_NOT_REGISTERED"
            );
    ...
    function _constructCircuitInput(
        ...
        require(
            ...
            "Wyzth::_constructCircuitInput: L2_TX_OVERFLOW"
        );
        assembly {
        ...
        require(
            ...
            "Wyzth::_constructCircuitInput: INVALID_FEEIDXCOORDINATOR_LENGTH"
        );
        assembly {
            calldatacopy(ptr, dPtr, dLen)
        }
    ...
    function _safeApprove(
        ...
        require(
            ...
            "Wyzth::_safeApprove: ERC20_APPROVE_FAILED"
        );
    }
    ...
    function _safeTransfer(
        ...
        if (token == address(0)) {
            ...
            require(success, "Wyzth::_safeTransfer: ETH_TRANSFER_FAILED");
        } else {
            /* solhint-disable avoid-low-level-calls */
            (bool success, bytes memory data) = token.call(
            ...
            require(
                success && (data.length == 0 || abi.decode(data, (bool))),
                "Wyzth::_safeTransfer: ERC20_TRANSFER_FAILED"
            );
        }
    }
    ...
    function _safeTransferFrom(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            "Wyzth::_safeTransferFrom: ERC20_TRANSFERFROM_FAILED"
        );
    }
    ...
    function _permit(
        ...
        require(
            ...
            "WyzthAuctionProtocol::_permit: NOT_VALID_CALL"
        );
        (
            address owner,
            address spender,
        ...
        require(
            owner == msg.sender,
            "Wyzth::_permit: PERMIT_OWNER_MUST_BE_THE_SENDER"
        );
        require(
            spender == address(this),
            "Wyzth::_permit: SPENDER_MUST_BE_THIS"
        );
        require(
            value == _amount,
            "Wyzth::_permit: PERMIT_AMOUNT_DOES_NOT_MATCH"
        );
